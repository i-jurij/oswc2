...
trait ClearFile
{
     ...
     * @param int    $keep_num_lines - the number of lines to save, starting from the end of the file, default is 10
     */
    public static function clearFile($path_to_file, $keep_num_lines = 10): bool
    {
